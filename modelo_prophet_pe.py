...
# Cargar el dataset
data = pd.read_csv("spot_prices.csv", parse_dates=['datetime'])
...
df = data[['value']].reset_index().rename(columns={'datetime': 'ds', 'value': 'y'})
...
with open('prophet_model_precios.pkl', 'wb') as pkl_file:
    pickle.dump(model, pkl_file)

# Guardar las predicciones en un archivo CSV
test_data[['y', 'Predictions']].to_csv("predicciones_prophet.csv")
