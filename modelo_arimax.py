...
# Separar las variables exógenas
train_exog = train[['T2m']]
test_exog = test[['T2m']]

# Definir el modelo SARIMAX
model = SARIMAX(train['G(i)'], exog=train_exog, order=(2, 1, 0), seasonal_order=(1, 1, 0, 12))
...
predicciones_df.to_csv('predicciones_sarimax.csv')
